...
$upcToNameURL="https://ae.pricecharting.com/api/product?t=%1&upc=%2";
//used to convert The name to an gameDB.net id;
...
$uid="c0b53bce27c1bdab90b1605249e600dc43dfd1d5";
...
$JSON_Array['Platform'] = str_replace("+"," ",(string)$Platform);
