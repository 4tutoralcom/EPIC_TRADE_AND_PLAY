...
$(document).ready(function() {
	...
	$("#addToCart #submit").click(function() {
		data = $("#addToCart :input").serializeArray();
		data.push({name: 'has_case', value: $("#addToCart #has_case").hasClass("active")});
		data.push({name: 'has_book', value: $("#addToCart #has_book").hasClass("active")});
		data.push({name: 'has_game', value: $("#addToCart #has_game").hasClass("active")});
		$.post($("#addToCart").attr("action"), data,
						function(info) {
						alert(info);
						});
	});
